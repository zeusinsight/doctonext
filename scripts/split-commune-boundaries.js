...
const inputFile = path.join(__dirname, '..', 'src', 'lib', 'data', 'commune-boundaries.json')
...
try {
  ...
  console.log(`Total split: ${((part1Size + part2Size) / 1024 / 1024).toFixed(2)} MB`)

  console.log('\n✅ Successfully split commune boundaries!')
  console.log('You can now remove the original commune-boundaries.json file if desired.')
