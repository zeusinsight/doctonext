...
export const transferDetailsSchema = z.object({
    ...
    chargesPercentage: z
        .string()
        .min(1, "Le pourcentage de charges est requis"),
...
export const replacementDetailsSchema = z.object({
    ...
    feeSharePercentage: z
        .string()
        .min(1, "Le pourcentage de rétrocession est requis"),
    dailyRate: z
        .union([
            z
                .string()
                ...
                .refine((val) => val === undefined || val > 0, {
                    message:
                        "La rémunération journalière doit être un nombre positif"
                }),
            z.number().positive(),
            z.undefined()
        ])
...
export const collaborationDetailsSchema = z.object({
    ...
    remunerationModel: z
        .string()
        .min(1, "Le modèle de rémunération est requis"),
    specialtiesWanted: z
        .array(z.string())
        .min(1, "Au moins une spécialité recherchée est requise"),
...
export const createListingSchema = z
    ...
    .refine(
        (data) => {
            ...
            if (
                data.listingType === "collaboration" &&
...
export const listingFiltersSchema = z.object({
    listingType: z
        .enum(["transfer", "replacement", "collaboration"])
        .optional(),
    specialty: z.string().optional(),
    ...
    sortBy: z
        .enum(["newest", "oldest", "price_low", "price_high", "views"])
        .default("newest"),
