            ...
            <section className="px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <p className="mt-6 text-gray-600 text-lg leading-8">
                        ...
                        santé qui souhaitent céder, reprendre ou collaborer dans
                        le secteur médical.
                    </p>
                        ...
                        <CardContent className="p-8">
                            <div className="text-center">
                                ...
                                <p className="text-gray-700 text-lg leading-relaxed">
                                    ...
                                    collaborations. Notre objectif est de créer
                                    un écosystème de confiance où chaque
                                    professionnel peut trouver les opportunités
                                    qui correspondent à ses aspirations et à son
                                    projet de carrière.
                                </p>
                            </div>
                        </CardContent>
            ...
            <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-6xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-gray-600 text-lg">
                            Une plateforme pensée par et pour les professionnels
                            de santé
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <p className="text-gray-600">
                                    Vérification des profils, données sécurisées
                                    et processus transparents pour des
                        ...
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <p className="text-gray-600">
                                    ...
                                    de santé partageant les mêmes valeurs et
                                    objectifs.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <p className="text-gray-600">
                                    Messagerie intégrée, outils de collaboration
                                    et suivi des échanges pour une communication
                                    fluide.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <p className="text-gray-600">
                                    Génération de contrats, outils d'évaluation
                                    et accompagnement personnalisé pour vos
                                    projets.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <p className="text-gray-600">
                                    Interface intuitive, recherche avancée et
                                    notifications intelligentes pour optimiser
                                    votre recherche.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <p className="text-gray-600">
                                    Une équipe d'experts du secteur médical pour
            ...
            <section className="px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-gray-600 text-lg">
                            Une plateforme en croissance constante au service
            ...
            <section className="bg-gray-50 px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-gray-600 text-lg">
                            Trois types d'opportunités pour répondre à tous vos
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-gray-600">
                                            ...
                                            médical en toute sérénité. Accédez
                                            aux informations financières, à la
                                            patientèle, aux équipements et
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-gray-600">
                                            ...
                                            temporaires, de long terme ou pour
                                            les week-ends. Que vous soyez
                                            remplaçant ou que vous cherchiez un
                                            remplaçant, connectez-vous
                                            facilement avec des professionnels
                                            qualifiés.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-gray-600">
                                            ...
                                            association, partenariat ou dans un
                                            cabinet de groupe. Trouvez des
                                            collaborateurs partageant votre
                                            vision pour créer une pratique
                                            médicale enrichissante et durable.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
