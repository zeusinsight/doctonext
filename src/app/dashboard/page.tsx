...
import { RiFileList3Line, RiExchangeFundsLine, RiAlarmWarningLine, RiSettings4Line } from "@remixicon/react"
...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <span className="text-gray-500">(1 avis)</span>
                                </div>
                            </div>
                        </div>
                        <Button onClick={() => {router.push("/dashboard/settings")}} variant="outline" className="text-blue-600 border-blue-200 hover:bg-blue-50">
                            Modifier
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                    <CardContent className="p-0">
                        <h3 className="text-lg font-medium text-gray-900 mb-2">Porte-monnaie</h3>
                    ...
                    <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:-translate-y-1">
                        <CardContent className="p-0">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1 text-lg">Annonces</h3>
                                    <p className="text-gray-600 text-sm">Gérer mes annonces déposées</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:-translate-y-1">
                    <CardContent className="p-0">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1 text-lg">Transactions</h3>
                                <p className="text-gray-600 text-sm">Suivre mes achats et ventes</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:-translate-y-1">
                    <CardContent className="p-0">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1 text-lg">Alertes</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card onClick={() => router.push('/dashboard/settings')} className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:-translate-y-1">
                    <CardContent className="p-0">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1 text-lg">Paramètres</h3>
                                <p className="text-gray-600 text-sm">Compléter et modifier vos informations</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
