    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-white">Retrouvez toutes vos annonces favorites</p>
        </div>
            ...
            <div className="flex flex-col items-center justify-center gap-4 py-12 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-md text-sm text-muted-foreground">
                  ...
                  Parcourez les annonces et cliquez sur le cœur pour les
                  sauvegarder ici.
                </p>
              </div>
              <Button asChild>
              ...
              {filteredFavorites.map((favorite) => (
                <div key={favorite.favoriteId} className="group relative">
                  ...
                  <div className="absolute bottom-3 right-3 text-xs text-gray-400 opacity-0 transition-opacity group-hover:opacity-100">
                    Ajouté le{" "}
                    {new Date(favorite.favoriteCreatedAt).toLocaleDateString(
                      "fr-FR",
                    )}
                  </div>
                </div>
