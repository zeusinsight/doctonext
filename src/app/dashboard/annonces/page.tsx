            ...
            <Card key={index} className="overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute right-2 top-2">
                  <div className="h-8 w-8 bg-muted-foreground/20 rounded-full animate-pulse" />
                </div>
              </div>
          ...
          <CardContent className="pt-8">
            <div className="flex flex-col items-center justify-center gap-3 py-8 text-center">
              ...
              <p className="max-w-md text-sm text-muted-foreground">
                Créez votre première annonce pour commencer à recevoir des vues
                et des contacts.
              </p>
              <Button asChild>
                <Link href="/dashboard/annonces/new">
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          {filteredListings.map((listing) => {
            ...
            return (
              <Card
                key={listing.id}
                className="group overflow-hidden border hover:shadow-md transition-shadow py-safe-offset-0"
              >
                <div className="relative">
                  ...
                  <div className="absolute left-2 top-2 flex gap-2">
                    ...
                    {listing.isBoostPlus && (
                      <Badge
                        variant="outline"
                        className="border-amber-500/60 text-amber-600 bg-amber-50"
                      >
                        Boost+
                      </Badge>
                    )}
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="secondary"
                          size="icon"
                          className="h-8 w-8 rounded-full bg-background/20 backdrop-blur shadow-sm hover:bg-background/30"
                        >
