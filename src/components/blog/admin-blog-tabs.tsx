...
export function AdminBlogTabs({ allArticles, publishedArticles, draftArticles, stats }: AdminBlogTabsProps) {
...
function ArticlesList({ articles, showStatus }: { articles: BlogArticle[], showStatus?: boolean }) {
            ...
            <Card>
                <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-muted-foreground text-center mb-4">
                        Vous n&apos;avez pas encore d&apos;article dans cette catégorie.
                    </p>
