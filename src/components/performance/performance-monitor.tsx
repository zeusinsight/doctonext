...
export function PerformanceMonitor({
    ...
    useEffect(() => {
        const updateMemoryUsage = () => {
            if ("memory" in performance) {
                ...
                setMetrics((prev) => ({
                    ...prev,
                    memoryUsage: Math.round(usedJSHeapSize)
                }))
            }
        }
    ...
    const getPerformanceStatus = () => {
        ...
        if (metrics.fps >= 25)
            return { color: "text-orange-600", status: "Fair" }
    ...
    return (
        <div className="fixed bottom-4 left-4 z-[2000] max-w-xs rounded-lg bg-black/80 p-3 font-mono text-white text-xs backdrop-blur-sm">
            ...
            <div className="space-y-1">
                ...
                <div className="mt-1 border-gray-600 border-t pt-1">
                    <div className="flex items-center justify-between">
                        <span>Polygons:</span>
                        <span
                            className={
                                metrics.polygonCount > 1000
                                    ? "text-yellow-400"
                                    : "text-green-400"
                            }
                        >
