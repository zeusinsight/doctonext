...
export function FranceMap({
    ...
    const [communeData, setCommuneData] =
        useState<FeatureCollection<any> | null>(null)
    ...
    const onDepartmentClick = useCallback(
        async (feature: DepartmentFeature, layer: L.Layer) => {
            ...
            if (map && "getBounds" in layer && typeof layer.getBounds === "function") {
    ...
    const onCommuneClick = useCallback(
        (feature: CommuneFeature) => {
            ...
            const displayName =
                feature.properties.l_ar || feature.properties.nom
            ...
            >
                ...
                {communeData && (
                    <GeoJSON
                        ...
                        data={communeData}
                        style={(feature) =>
                            getCommuneStyle(feature as CommuneFeature)
                        }
