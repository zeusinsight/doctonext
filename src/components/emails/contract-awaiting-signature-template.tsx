    ...
    const content = React.createElement(
        ...
        React.createElement("div", { 
            ...
            React.createElement("ul", { 
                ...
                React.createElement("li", { style: { marginBottom: "4px" } }, "Cliquez sur le lien pour accéder au contrat"),
                React.createElement("li", { style: { marginBottom: "4px" } }, "Lisez attentivement le document"),
                React.createElement("li", { style: { marginBottom: "4px" } }, "Signez électroniquement aux endroits indiqués"),
                React.createElement("li", null, "Vous et l'autre partie recevrez le contrat signé par email")
            ])
        ]),
