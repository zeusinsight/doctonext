...
export function ProfessionalRegisterForm() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-600 to-blue-700">
            ...
            <div className="container mx-auto flex min-h-screen grow flex-col items-center justify-center gap-4 self-center py-8 sm:py-12">
                ...
                <Card className="w-full max-w-4xl bg-white/95 shadow-2xl backdrop-blur-md">
                    <CardHeader className="text-center">
                        <CardTitle className="font-bold text-2xl text-blue-700">
                        ...
                        >
                            ...
                            <div className="border-t pt-4">
                                <Button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full bg-blue-600 font-medium text-white shadow-lg transition-all hover:bg-blue-700 hover:shadow-xl"
                                >
                                    {isLoading
                                        ? "Création en cours..."
