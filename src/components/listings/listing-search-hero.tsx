...
export function ListingSearchHero({
    ...
    return (
        <div className="px-4 py-8 sm:py-10" style={{ background: "linear-gradient(to right, #14b8a6, #0d9488)" }}>
            <div className="container mx-auto max-w-7xl">
                <h1 className="mb-5 font-semibold text-xl text-white sm:text-2xl">
                ...
                <div className="mb-4 flex flex-col gap-3 sm:mb-6 sm:flex-row">
                    ...
                    {/* View toggle and filter button row */}
                    <div className="flex gap-3">
                        ...
                        <Button
                            ...
                            className={cn(
                                "relative h-11 flex-1 border-0 bg-white text-gray-700 hover:bg-gray-50 sm:flex-none",
                                activeFiltersCount > 0 &&
                ...
                <div className="flex flex-wrap gap-2">
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={cn(
                                "rounded-md px-3 py-2 font-medium text-sm transition-colors sm:px-4",
                                activeTab === tab.id
