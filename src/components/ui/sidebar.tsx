...
function SidebarGroupLabel({
    ...
    return (
        <Comp
            ...
            className={cn(
                "mb-3 flex shrink-0 items-center rounded-md px-2 font-medium text-sidebar-foreground/70 text-xs outline-hidden ring-sidebar-ring transition-[margin,opacity,transform] duration-300 ease-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
